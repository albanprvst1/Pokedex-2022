  ...
  <div class="detail">
    <div class="detail-view card">
      <div class="data card-body">
        <img class="image" v-bind:src="pokemonImage+'/'+pokemonDetails.name+'.png'">
        <h2 class="card-title">{{pokemonDetails.name}}</h2>

        <div class="property">
          <div class="left bold">N° pokedex :</div>
          <div class="right">{{pokemonDetails.id}}</div>
        </div>

        <div class="property">
          <div class="left bold">Types :</div>
        </div>
        <div class="types" v-for="type in pokemonDetails.types" v-bind:key="type.id">
          <div class="type">
        ...
        <div class="property">
          <div class="left bold">Talents :</div>
        </div>
        <div class="abilities" v-for="talent in pokemonDetails.abilities" v-bind:key="talent.id">
          <div class="ability">
            <span>{{talent.ability.name}}</span>
          </div>
        </div>

        <div class="property">
          <div class="left bold">Taille :</div>
          <div class="right">{{pokemonDetails.height}}</div>
        </div>

        <div class="property">
          <div class="left bold">Poids :</div>
          <div class="right">{{pokemonDetails.weight}}</div>
        </div>
      </div>
